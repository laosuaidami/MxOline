...
class EmailVerifyRecord(models.Model):
    ...
    send_type = models.CharField(max_length=10, choices=(('register', '注册'), ('forget', '找回密码'), ('update', '修改邮箱')), verbose_name='验证码类型')
...
class Banner(models.Model):
    ...
    image = models.ImageField(upload_to='banner/%Y/%m', verbose_name='轮播图', max_length=100, null=True, blank=True)
